...
class InboxHandler Extends ConfigLoader
{
	...
	private function process($message)
	{
		switch($message["t"])
		{
			case "MESSAGE_CREATE": return $this->MESSAGE_CREATE($message["d"]);
			case "MESSAGE_UPDATE": return $this->MESSAGE_UPDATE($message["d"]);
			case "MESSAGE_DELETE": return $this->MESSAGE_DELETE($message["d"]);
		}
		return true;
	}
